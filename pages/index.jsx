...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    { role: "ai", text: "Welcome to FutureTokenization.com. I'm the <strong>Digital Czar</strong> — your AI intelligence guide to tokenization, real-world assets, stablecoins, CBDCs, and digital finance. Ask me anything, from first principles to institutional strategy. <em>All responses are educational only and not financial advice.</em>" }
  ]);
  const [isThinking, setIsThinking] = useState(false);
  const messagesEndRef = useRef(null);

  useEffect(() => {import Head from 'next/head';
import { useEffect, useRef, useState } from 'react';
...
export default function Home() {
  ...
  async function sendMessage(userMsg) {
    ...
    try {
      ...
      const reply = data.reply || 'I could not process that request. Please try again.';
...
<nav>
  <div className="nav-inner">
    ...
    <div className="nav-right">
      <button className="btn-ai" id="chat-toggle-btn">⚡ Ask the Digital Czar</button>
    </div>
  </div>
</nav>
...
<div id="home">
  ...
  <div className="hero-content">
    ...
    <div className="hero-ctas">
      ...
      <button className="btn-secondary" onClick={() => document.getElementById("case-studies").scrollIntoView({behavior:"smooth"})}>View Case Studies</button>
      <button className="btn-secondary" onClick={() => setChatOpen(true)}>⚡ Ask the Digital Czar</button>
    </div>
  </div>
  <div className="stats-bar" style="padding:0 24px;margin:0 auto 0;max-width:1400px;">
    <div className="stat-item">
      <div className="stat-num">$19T</div>
      <div className="stat-label">Projected RWA Market by 2033</div>
      <div className="stat-trend">↑ from $35B today</div>
    </div>
    <div className="stat-item">
      <div className="stat-num">$250B</div>
      <div className="stat-label">Stablecoin Supply in Circulation</div>
      <div className="stat-trend">↑ 460% YoY growth (Visa)</div>
    </div>
    <div className="stat-item">
      <div className="stat-num">134</div>
      <div className="stat-label">Countries Exploring CBDCs</div>
      <div className="stat-trend">↑ 98% of global GDP</div>
    </div>
    <div className="stat-item">
      <div className="stat-num">$8.7B</div>
      <div className="stat-label">Tokenized Treasuries On-Chain</div>
      <div className="stat-trend">↑ From $100M in 2023</div>
    </div>
  </div>
</div>
...
<section id="tokenization" style="padding-top:100px;">
  ...
  <p className="sec-sub">Tokenization is the process of converting rights to a real-world asset into a digital token on a blockchain. Think of it as creating a digital twin of a physical or financial asset — one that can be traded instantly, globally, and in fractions of a cent.</p>
  ...
  <div className="card-grid">
    <div className="card">
      ...
      <div className="card-h">Asset Selection</div>
      <div className="card-p">Any revenue-generating or value-holding asset can be tokenized: real estate, debt, commodities, equity, art, music royalties, carbon credits, or intellectual property.</div>
      <span className="card-tag tag-gold">Step 1</span>
    </div>
    <div className="card">
      <div className="card-icon">⚖️</div>
      <div className="card-h">Legal Structure</div>
      <div className="card-p">A legal wrapper (SPV, trust, or fund) holds the asset. Smart contracts encode the rights: ownership percentage, income distributions, voting rights, and transfer restrictions.</div>
      <span className="card-tag tag-gold">Step 2</span>
    </div>
    <div className="card">
      <div className="card-icon">🔗</div>
      <div className="card-h">On-Chain Issuance</div>
      <div className="card-p">Tokens are minted on a blockchain (Ethereum, Solana, Avalanche, XRP Ledger). Each token represents a precise fractional claim on the underlying asset.</div>
      <span className="card-tag tag-gold">Step 3</span>
    </div>
    <div className="card">
      <div className="card-icon">🛂</div>
      <div className="card-h">KYC / Compliance</div>
      <div className="card-p">Investor whitelisting via KYC/AML ensures only verified, eligible investors can hold tokens. Standards like ERC-3643 (created by Tokeny) enforce this on-chain automatically.</div>
      <span className="card-tag tag-gold">Step 4</span>
    </div>
    <div className="card">
      <div className="card-icon">📊</div>
      <div className="card-h">Primary Offering</div>
      <div className="card-p">Tokens are sold to investors via regulated platforms (Securitize, DigiFT, STOKR) or licensed exchanges. Minimum investments can be as low as $10–$1,000.</div>
      <span className="card-tag tag-gold">Step 5</span>
    </div>
    <div className="card">
      <div className="card-icon">🔄</div>
      <div className="card-h">Secondary Trading</div>
      <div className="card-p">Token holders can trade on compliant secondary markets (ATS, DEX with whitelisting). Settlement is near-instant vs. T+2 days in traditional markets.</div>
      <span className="card-tag tag-gold">Step 6</span>
    </div>
  </div>
  ...
  <div className="tech-stack">
    <div className="layer">
      ...
      <div className="layer-name">Blockchain Infrastructure</div>
      <div className="layer-detail">Ethereum, Solana, XRP Ledger, Avalanche, Polygon — the base layer providing consensus, security, and immutability. The "internet" of tokenization.</div>
      <div className="layer-badge"><span className="card-tag tag-blue">Foundation</span></div>
    </div>
    <div className="layer">
      <div className="layer-num">L2</div>
      <div className="layer-name">Smart Contract Standards</div>
      <div className="layer-detail">ERC-20 (fungible), ERC-721 (NFT), ERC-1400 (securities), ERC-3643 (compliant tokens by Tokeny). These standards define how tokens behave, transfer, and enforce compliance.</div>
      <div className="layer-badge"><span className="card-tag tag-blue">Protocol</span></div>
    </div>
    <div className="layer">
      <div className="layer-num">L3</div>
      <div className="layer-name">Tokenization Platforms</div>
      <div className="layer-detail">Securitize, Tokeny, Fireblocks, Taurus, Polymath — middleware platforms providing the investor portal, KYC/AML integration, compliance engine, cap table management, and custody tooling.</div>
      <div className="layer-badge"><span className="card-tag tag-gold">Platform</span></div>
    </div>
    <div className="layer">
    ...
    <div className="layer">
      ...
      <div className="layer-name">Cross-Chain Interoperability</div>
      <div className="layer-detail">Chainlink CCIP (institutional standard), LayerZero (30+ chains), Cosmos IBC (85+ chains) — allow tokenized assets to move between blockchains without being locked to a single ecosystem.</div>
      <div className="layer-badge"><span className="card-tag tag-blue">Bridge</span></div>
    </div>
    <div className="layer">
  ...
  <div className="timeline">
    <div className="tl-item">
      ...
      <div className="tl-h">Bitcoin — Proof of Concept</div>
      <div className="tl-p">Satoshi Nakamoto demonstrates that digital scarcity is possible without a central authority. The foundation for all tokenization is laid.</div>
    </div>
    <div className="tl-item">
      <div className="tl-dot"></div>
    ...
    <div className="tl-item">
      ...
      <div className="tl-h">First-Generation RWA Attempts</div>
      <div className="tl-p">Early real estate tokenization projects (Harbor, Polymath) prove the concept but struggle with regulatory clarity, thin liquidity, and lack of institutional infrastructure.</div>
    </div>
    <div className="tl-item">
      <div className="tl-dot"></div>
    ...
    <div className="tl-item">
      ...
      <div className="tl-h">Institutional RWA Inflection Point</div>
      <div className="tl-p">Franklin Templeton's Benji product (first US-registered mutual fund on blockchain) and Ondo Finance's tokenized Treasuries prove institutional-grade product-market fit. TVL explodes from $100M to $1B+.</div>
    </div>
    <div className="tl-item">
      <div className="tl-dot"></div>
      <div className="tl-year">2024</div>
      <div className="tl-h">BlackRock Enters — BUIDL Fund</div>
      <div className="tl-p">BlackRock (world's largest asset manager, $10T AUM) launches BUIDL on Ethereum via Securitize. This single event legitimizes institutional tokenization at the highest level.</div>
    </div>
    <div className="tl-item">
      <div className="tl-dot"></div>
    ...
    <div className="tl-item">
      ...
      <div className="tl-h">Mainstream Institutional Adoption</div>
      <div className="tl-p">Tokenized RWA exceeds $35B. UAE, Singapore, and Pakistan lead emerging market adoption. Cross-chain infrastructure matures. The race to $19T by 2033 begins in earnest.</div>
    </div>
  </div>
  ...
  <div style="margin-top:60px;" id="rwa-catalyst">
    ...
    <p className="sec-sub" style="margin-bottom:40px;">Tokenization has existed as a concept since 2015. So why is 2025–2027 the era when it actually happens at scale? Six simultaneous catalysts have converged — and the window for first-movers is closing fast.</p>

    <div className="highlight-box" style="margin-bottom:40px;">
    ...
    <div className="card-grid" style="margin-bottom:48px;">
      <div className="card">
        <div className="card-icon">⚖️</div>
        <div className="card-h">Catalyst 1 — Regulatory Clarity Arrived</div>
        <div className="card-p">For years institutions stayed out because no one knew the rules. Then the GENIUS Act (US stablecoin framework), MiCA (EU), MAS SCS (Singapore), VARA (UAE), and HKMA (Hong Kong) all issued workable frameworks within 18 months of each other. The legal fog lifted. Compliance teams have something to work with. The boardroom objection "it's not regulated" is now obsolete in every major financial center.</div>
        <span className="card-tag tag-green">Resolved 2024–2025</span>
      </div>
      <div className="card">
        <div className="card-icon">🏦</div>
        <div className="card-h">Catalyst 2 — The BlackRock Effect</div>
        <div className="card-p">When the world's largest asset manager ($10 trillion AUM) launches a tokenized fund on Ethereum, the institutional risk committee calculus changes permanently. BUIDL was the signal every pension fund, sovereign wealth fund, and family office needed. If BlackRock can, everyone can. Within 12 months of BUIDL's launch, $8.7B in tokenized Treasuries existed on-chain. That is not coincidence — that is institutional permission granted at the highest level.</div>
        <span className="card-tag tag-gold">2024 Turning Point</span>
      </div>
      <div className="card">
        <div className="card-icon">🔧</div>
        <div className="card-h">Catalyst 3 — Infrastructure Is Now Complete</div>
        <div className="card-p">In 2019, building a tokenized product required custom engineering of every layer. Today, Securitize handles compliance and cap table management, Fireblocks handles custody, Chainlink CCIP handles cross-chain movement, and ERC-3643 handles transfer restrictions. The full stack exists off-the-shelf. Time-to-market for a tokenized fund dropped from 18 months to 6 weeks. The infrastructure tax went from prohibitive to negligible.</div>
        <span className="card-tag tag-blue">Stack Complete 2024</span>
      </div>
      <div className="card">
        <div className="card-icon">💰</div>
        <div className="card-h">Catalyst 4 — Stablecoins Proved the Rails Work</div>
        <div className="card-p">Stablecoins processed $33 trillion in annual transaction volume — more than PayPal, approaching Visa. This proved that blockchain-native money works at civilizational scale. Every tokenized asset settles in stablecoins. The existence of deep, liquid stablecoin markets is the prerequisite for liquid RWA markets. The plumbing was installed by stablecoins. Now the assets flow through it.</div>
        <span className="card-tag tag-blue">$33T Annual Volume</span>
      </div>
      <div className="card">
        <div className="card-icon">📉</div>
        <div className="card-h">Catalyst 5 — Traditional Finance Under Structural Stress</div>
        <div className="card-p">The bond market paradox (yields rising despite rate cuts), gold at $5,111, central banks buying 60 tonnes/month for three years, and BlackRock itself going underweight US Treasuries — institutional capital is actively searching for new vehicles. Tokenized assets offer what traditional markets cannot: 24/7 settlement, fractional access, DeFi composability, and immutable audit trails. Push-out from traditional finance meets pull of digital infrastructure at this precise moment.</div>
        <span className="card-tag tag-red">Macro Pressure 2026</span>
      </div>
      <div className="card">
        <div className="card-icon">🌍</div>
        <div className="card-h">Catalyst 6 — Emerging Market Demand Is Explosive</div>
        <div className="card-p">Pakistan tokenizing $2B in sovereign bonds. Punjab committing to RWA-backed FDI. UAE as the world's most active tokenization sandbox. Latin America using stablecoins for 71% of cross-border payments. The demand is not coming only from Wall Street — it is coming from the 5 billion people who never had efficient access to capital markets. Emerging market governments see tokenization as a leapfrog technology that bypasses 50 years of financial infrastructure they never built.</div>
        <span className="card-tag tag-gold">Global Demand</span>
      </div>
    </div>
    ...
    <div className="tech-stack" style="margin-bottom:40px;">
      <div className="layer">
        <div className="layer-num">01</div>
        <div className="layer-name">Asset Selection</div>
        <div className="layer-detail">Any asset with definable value and legal ownership qualifies. The highest-value candidates are illiquid assets with high barriers to entry: a $200M office tower, a portfolio of SME loans, a gold vault, a crop harvest. The more friction traditional finance creates around an asset, the more value tokenization destroys by removing that friction.</div>
        <div className="layer-badge"><span className="card-tag tag-gold">Day 1</span></div>
      </div>
      <div className="layer">
        <div className="layer-num">02</div>
        <div className="layer-name">Legal Structuring (SPV / Trust)</div>
        <div className="layer-detail">A Special Purpose Vehicle, trust, or regulated fund is created to legally hold the asset. Token holders own shares in this legal wrapper — not the asset directly. Every jurisdiction requires different structures: Dubai uses DLD-registered SPVs; US uses Delaware trusts; EU uses Irish or Luxembourg SPVs. The legal wrapper is the non-negotiable bridge between the physical world and blockchain.</div>
        <div className="layer-badge"><span className="card-tag tag-gold">Weeks 1–4</span></div>
      </div>
      <div className="layer">
...
<section id="rwa">
  ...
  <p className="sec-sub">Real-world assets (RWAs) are off-chain assets brought onto blockchain through tokenization. Every asset class in the $900+ trillion global asset universe is a candidate. Here is the complete landscape of what is being tokenized today.</p>
  ...
  <table className="data-table fade-in">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td className="num">$300T</td>
        <td className="num green">$20B</td>
      ...
      <tr>
        ...
        <td className="num green">$350M</td>
      ...
      <tr>
        ...
        <td className="num green">$200M</td>
  ...
  <div className="card-grid">
    <div className="card">
      <div className="card-h">BlackRock BUIDL</div>
      <div className="card-p">Launched on Ethereum via Securitize. First tokenized fund from the world's largest asset manager ($10T AUM). Sets the institutional gold standard for tokenized government securities.</div>
      <span className="card-tag tag-gold">$1B+ AUM</span>
    </div>
    <div className="card">
      <div className="card-h">Ondo Finance OUSG</div>
      <div className="card-p">Tokenized US Treasuries and money markets. $2.5B TVL. Pioneer of "yield-bearing" stablecoin alternatives. Provides crypto-native institutions access to risk-free rate.</div>
      <span className="card-tag tag-gold">$2.5B TVL</span>
    </div>
    <div className="card">
      <div className="card-h">Franklin Templeton Benji</div>
      <div className="card-p">First US-registered mutual fund on blockchain ($880M+). Uses Stellar and Polygon. Investors can transfer shares peer-to-peer, 24/7, without a broker.</div>
      <span className="card-tag tag-blue">$880M+</span>
    </div>
    <div className="card">
      <div className="card-h">Superstate USTB</div>
      <div className="card-p">Tokenized short-duration US government securities. Built by Compound Finance founder Robert Leshner. Institutional-grade, SEC-compliant wrapper for on-chain cash management.</div>
      <span className="card-tag tag-blue">SEC Compliant</span>
    </div>
  </div>
...
<section id="stablecoins" style="position:relative;">
  ...
  <p className="sec-sub">Stablecoins are digital currencies pegged to a stable asset (usually the US dollar). They are financial infrastructure — the settlement layer of the new digital economy. Understanding why they are fundamentally different from cryptocurrency is essential.</p>

  <div id="stable-vs-crypto">
    <div className="vs-grid">
      <div className="vs-col">
        <div className="vs-head">
          <div className="vs-col-title" style="color:var(--blue);">💵 Stablecoins</div>
          <div className="vs-col-sub">Price-Stable Digital Infrastructure</div>
        </div>
        <div className="vs-items">
          <div className="vs-item">
            <div className="vs-icon">✅</div>
            <div className="vs-text"><strong>Pegged Value:</strong> 1 USDC = $1.00 always. No price volatility.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">✅</div>
            <div className="vs-text"><strong>Backed by Real Assets:</strong> USDC is backed 1:1 by US dollars and short-term Treasuries held by regulated custodians.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">✅</div>
            <div className="vs-text"><strong>Payment Tool:</strong> Used to pay suppliers, settle trades, send remittances. Visa processed $4.5B annualized in stablecoin card spending (Jan 2026).</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">✅</div>
            <div className="vs-text"><strong>DeFi Settlement Layer:</strong> The "dollar" of blockchain. All RWA transactions settle in stablecoins. $33T annual transaction volume.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">✅</div>
            <div className="vs-text"><strong>Regulated Path:</strong> GENIUS Act (2025) created the first federal US framework. EU MiCA covers stablecoin issuers. Singapore MAS has licensing regime.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">✅</div>
            <div className="vs-text"><strong>Treasury Buyers:</strong> USDT and USDC issuers collectively hold $155B+ in US Treasury bills — among the largest T-bill buyers in the world.</div>
          </div>
        </div>
      </div>
      ...
      <div className="vs-col">
        <div className="vs-head">
          <div className="vs-col-title" style="color:var(--gold);">₿ Cryptocurrency</div>
          <div className="vs-col-sub">Speculative Digital Assets</div>
        </div>
        <div className="vs-items">
          <div className="vs-item">
            <div className="vs-icon">⚡</div>
            <div className="vs-text"><strong>Volatile Price:</strong> Bitcoin dropped 31% in a year while still being considered a bull market. Daily 5–10% swings are normal.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">⚡</div>
            <div className="vs-text"><strong>No Direct Backing:</strong> Bitcoin's value is derived from scarcity (21M supply cap) and network effect, not collateral.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">⚡</div>
            <div className="vs-text"><strong>Store of Value / Speculation:</strong> Bitcoin and Ethereum are held as inflation hedges or traded for appreciation. Not used for daily commerce.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">⚡</div>
            <div className="vs-text"><strong>Blockchain Infrastructure:</strong> ETH powers smart contracts. BTC is "digital gold." These are foundational layers, not settlement currencies.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">⚡</div>
            <div className="vs-text"><strong>Regulatory Gray Area:</strong> SEC vs. CFTC jurisdictional battles continue. Securities vs. commodity classification unresolved for many tokens.</div>
          </div>
          <div className="vs-item">
            <div className="vs-icon">⚡</div>
            <div className="vs-text"><strong>Debasement Hedge:</strong> Goldman Sachs calls Bitcoin/Gold investment "the debasement trade" — a bet against sovereign currency stability.</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div className="card-grid">
    <div className="card">
      <div className="card-icon">🏦</div>
      <div className="card-h">Fiat-Backed (Custodial)</div>
      <div className="card-p">1:1 backed by dollars, euros, or government bonds held by a regulated custodian. Most trusted, most regulated. Examples: USDC (Circle), USDT (Tether), USDP (Paxos).</div>
      <span className="card-tag tag-green">Lowest Risk</span>
    </div>
    <div className="card">
      <div className="card-icon">🏛️</div>
      <div className="card-h">Government-Backed</div>
      <div className="card-p">Backed by sovereign debt instruments. USD1 (World Liberty Financial) is 100% backed by US cash and cash equivalents. $5B market cap in under one year of launch (March 2025).</div>
      <span className="card-tag tag-green">Institutional Grade</span>
    </div>
    <div className="card">
      <div className="card-icon">⛓️</div>
      <div className="card-h">Crypto-Backed (Decentralized)</div>
      <div className="card-p">Over-collateralized by cryptocurrency. DAI (MakerDAO) requires $150 in ETH to mint $100 in DAI. Decentralized but more complex, requires active management of collateral ratios.</div>
      <span className="card-tag tag-gold">Medium Risk</span>
    </div>
    <div className="card">
      <div className="card-icon">📊</div>
      <div className="card-h">Algorithmic</div>
      <div className="card-p">Maintain peg through supply/demand algorithms, no backing. Terra/UST collapsed spectacularly in 2022 ($40B destroyed in days). Heavily discouraged by new regulations. High risk.</div>
      <span className="card-tag tag-red">High Risk</span>
    </div>
    <div className="card">
      <div className="card-icon">📈</div>
      <div className="card-h">Yield-Bearing</div>
      <div className="card-p">Next-generation stablecoins that pass yield to holders. Ethena's USDe, backed by delta-neutral positions, delivers 8–15% yields. The "Clarity Act" debate determines if this can reach retail investors.</div>
      <span className="card-tag tag-blue">Emerging</span>
    </div>
    <div className="card">
      <div className="card-icon">🌍</div>
      <div className="card-h">Non-USD Stablecoins</div>
      <div className="card-p">EURC (Euro), XSGD (Singapore Dollar), Zand AED (UAE Dirham). As tokenization globalizes, multi-currency stable settlement becomes essential for cross-border trade finance.</div>
      <span className="card-tag tag-blue">Global Finance</span>
    </div>
  </div>
  ...
  <table className="data-table">
    ...
    <tbody>
      <tr>
        ...
        <td>Tether</td>
        <td className="num green">$139B+</td>
...
<section id="cbdc" style="position:relative;">
  ...
  <div id="cbdc-vs-stable">
    ...
    <div className="compare-table">
      <div className="ct-cell ct-head">Dimension</div>
      <div className="ct-cell ct-head">CBDC (Central Bank)</div>
      <div className="ct-cell ct-head">Fiat Stablecoin (e.g. USDC)</div>
      <div className="ct-cell ct-head">Decentralized Stablecoin (DAI)</div>

      <div className="ct-cell ct-label">Issuer</div>
      <div className="ct-cell">Government / Central Bank</div>
      <div className="ct-cell">Private company (Circle, Tether)</div>
      <div className="ct-cell">Decentralized protocol (MakerDAO)</div>

      <div className="ct-cell ct-label">Programmability</div>
      <div className="ct-cell">Government-controlled</div>
      <div className="ct-cell">Open (DeFi compatible)</div>
      <div className="ct-cell">Fully open (permissionless)</div>

      <div className="ct-cell ct-label">Privacy</div>
      <div className="ct-cell ct-no">✗ Full surveillance possible</div>
      <div className="ct-cell ct-part">◐ KYC required</div>
      <div className="ct-cell ct-yes">✓ Pseudonymous</div>

      <div className="ct-cell ct-label">Censorship Resistance</div>
      <div className="ct-cell ct-no">✗ None — government can freeze</div>
      <div className="ct-cell ct-no">✗ Issuers can blacklist addresses</div>
      <div className="ct-cell ct-yes">✓ No central control</div>

      <div className="ct-cell ct-label">Yield / Interest</div>
      <div className="ct-cell ct-part">◐ Government decision</div>
      <div className="ct-cell ct-part">◐ Regulatory debate</div>
      <div className="ct-cell ct-yes">✓ Protocol-determined</div>

      <div className="ct-cell ct-label">Cross-Border</div>
      <div className="ct-cell ct-part">◐ Requires bilateral agreements</div>
      <div className="ct-cell ct-yes">✓ Global, permissionless</div>
      <div className="ct-cell ct-yes">✓ Borderless by design</div>

      <div className="ct-cell ct-label">Expiry / Control</div>
      <div className="ct-cell ct-no">✗ Can expire or restrict use</div>
      <div className="ct-cell ct-part">◐ Compliance freezes</div>
      <div className="ct-cell ct-yes">✓ User-controlled</div>

      <div className="ct-cell ct-label">DeFi Compatible</div>
      <div className="ct-cell ct-no">✗ Generally no</div>
      <div className="ct-cell ct-yes">✓ Widely integrated</div>
      <div className="ct-cell ct-yes">✓ Native DeFi</div>
    </div>
  </div>
  ...
  <div className="cbdc-grid">
    <div className="cbdc-card">
      ...
      <div className="cbdc-country">China</div>
      <div className="cbdc-name">e-CNY (Digital Yuan)</div>
      <div className="cbdc-desc">World's most advanced CBDC. 260M+ wallets. $250B+ in transactions. Used for government stimulus, retail payments, and cross-border trade with BRI partners. Programmable spending restrictions.</div>
      <span className="cbdc-status status-live">LIVE — Mass Adoption</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇧🇸</div>
      <div className="cbdc-country">Bahamas</div>
      <div className="cbdc-name">Sand Dollar</div>
      <div className="cbdc-desc">World's first live retail CBDC (2020). Designed for financial inclusion across 700 islands. Lessons learned: adoption is slow without compelling consumer incentive.</div>
      <span className="cbdc-status status-live">LIVE — World's First</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇳🇬</div>
      <div className="cbdc-country">Nigeria</div>
      <div className="cbdc-name">eNaira</div>
      <div className="cbdc-desc">Launched 2021. Significant uptake challenges. Government offered discounts at Lagos markets to drive adoption. Transaction volumes low vs. mobile money alternatives.</div>
      <span className="cbdc-status status-live">LIVE — Low Adoption</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇮🇳</div>
      <div className="cbdc-country">India</div>
      <div className="cbdc-name">Digital Rupee (e₹)</div>
      <div className="cbdc-desc">Pilot launched Dec 2022. Retail and wholesale versions. RBI targeting 1M daily transactions. India's existing UPI payments infrastructure creates competition.</div>
      <span className="cbdc-status status-pilot">PILOT — Active</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇪🇺</div>
      <div className="cbdc-country">European Union</div>
      <div className="cbdc-name">Digital Euro</div>
      <div className="cbdc-desc">ECB in preparation phase (2023–2025). Focus on privacy protections as key design feature. Maximum holding limits proposed (€3,000) to prevent bank deposit flight.</div>
      <span className="cbdc-status status-pilot">Preparation Phase</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇬🇧</div>
    ...
    <div className="cbdc-card">
      <div className="cbdc-flag">🇺🇸</div>
      <div className="cbdc-country">United States</div>
      <div className="cbdc-name">No Federal CBDC</div>
      <div className="cbdc-desc">Trump signed executive order in Jan 2025 prohibiting development of a US retail CBDC. US strategy instead focuses on dollar-backed stablecoin dominance globally.</div>
      <span className="cbdc-status status-cancelled">Prohibited (EO 2025)</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇦🇪</div>
      <div className="cbdc-country">UAE</div>
      <div className="cbdc-name">Digital Dirham</div>
      <div className="cbdc-desc">Central Bank of UAE launched Digital Dirham strategy 2023. Wholesale CBDC for interbank settlement (mBridge project with BIS, China, HK, Thailand). Retail phase planned.</div>
      <span className="cbdc-status status-pilot">Wholesale Pilot</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇸🇬</div>
      <div className="cbdc-country">Singapore</div>
      <div className="cbdc-name">Project Orchid / Ubin</div>
      <div className="cbdc-desc">MAS running multiple CBDC experiments. Project Ubin tested wholesale settlement. Orchid explores retail CBDC with "purpose-bound money." One of world's most sophisticated research programs.</div>
      <span className="cbdc-status status-pilot">Advanced Research</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇧🇷</div>
      <div className="cbdc-country">Brazil</div>
      <div className="cbdc-name">DREX</div>
      <div className="cbdc-desc">Banco Central do Brasil launching DREX (Digital Real). Unique design: programmable wholesale CBDC integrated with tokenized government bonds. Pilots with 9 major banks.</div>
      <span className="cbdc-status status-pilot">Pilot — 2024/25</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇯🇲</div>
      <div className="cbdc-country">Jamaica</div>
      <div className="cbdc-name">JAM-DEX</div>
      <div className="cbdc-desc">Full national rollout 2022. Government incentivized adoption with $16 "wallet bonuses." Designed specifically for the 15% of population without bank accounts.</div>
      <span className="cbdc-status status-live">LIVE — Full Rollout</span>
    </div>
    <div className="cbdc-card">
      <div className="cbdc-flag">🇵🇰</div>
      <div className="cbdc-country">Pakistan</div>
      <div className="cbdc-name">Digital PKR (Planned)</div>
      <div className="cbdc-desc">State Bank of Pakistan exploring CBDC framework. MOU with World Liberty Financial (USD1) signed Jan 2026. Pakistan Crypto Council active. Unique: pursuing both sovereign digital currency and USD stablecoin partnerships simultaneously.</div>
      <span className="cbdc-status status-research">Research + RWA Strategy</span>
    </div>
  </div>
</section>
...
<section id="case-studies">
  ...
  <p className="sec-sub">The tokenization revolution is not theoretical. These are live deployments, real capital, and proven results from institutions that have moved first.</p>

  <div className="card-grid" style="grid-template-columns:repeat(auto-fill,minmax(320px,1fr));">
    <div className="case-card">
      <div className="case-card-head">
        <div className="case-logo">BlackRock BUIDL</div>
        <div className="case-sub">Tokenized Treasury Fund · Ethereum · 2024</div>
      </div>
      <div className="case-card-body">
        <div className="case-stat-row">
          <div className="case-stat"><div className="cs-num">$1B+</div><div className="cs-lbl">AUM</div></div>
          <div className="case-stat"><div className="cs-num">Securitize</div><div className="cs-lbl">Platform</div></div>
          <div className="case-stat"><div className="cs-num">T+0</div><div className="cs-lbl">Settlement</div></div>
        </div>
        <div className="case-desc">BlackRock, the world's largest asset manager ($10T AUM), launched its first tokenized fund on Ethereum. BUIDL holds US Treasury bills and repo agreements, distributed as ERC-20 tokens. The fund pays daily dividends. Ethena built USDtb — a stablecoin backed by BUIDL tokens. Traders use BUIDL as yield-bearing margin collateral. This "Russian Doll" composability effect demonstrates how tokenized Treasuries become the foundational layer of an entirely new financial stack.</div>
      </div>
    </div>
    <div className="case-card">
      <div className="case-card-head">
        <div className="case-logo">Franklin Templeton Benji</div>
        <div className="case-sub">First US-Registered Mutual Fund on Blockchain · 2021</div>
      </div>
      <div className="case-card-body">
        <div className="case-stat-row">
          <div className="case-stat"><div className="cs-num">$880M+</div><div className="cs-lbl">AUM</div></div>
          <div className="case-stat"><div className="cs-num">Stellar+Polygon</div><div className="cs-lbl">Chain</div></div>
          <div className="case-stat"><div className="cs-num">P2P</div><div className="cs-lbl">Transfer</div></div>
        </div>
        <div className="case-desc">Franklin Templeton's OnChain US Government Money Fund (FOBXX) was the first US-registered mutual fund to use blockchain for ownership records. The blockchain IS the official record. Investors receive BENJI tokens representing fund shares and can transfer them directly peer-to-peer without a broker. A $200 trillion asset manager proving that blockchain and regulatory compliance are fully compatible.</div>
      </div>
    </div>
    <div className="case-card">
      <div className="case-card-head">
        <div className="case-logo">PRYPCO Mint / DAMAC</div>
        <div className="case-sub">Tokenized UAE Real Estate · XRP Ledger · Full Case Study</div>
      </div>
      <div className="case-card-body">
        <div className="case-stat-row">
          <div className="case-stat"><div className="cs-num">224</div><div className="cs-lbl">Launch Investors</div></div>
          <div className="case-stat"><div className="cs-num">44</div><div className="cs-lbl">Countries</div></div>
          <div className="case-stat"><div className="cs-num">24hrs</div><div className="cs-lbl">First Offering Sold Out</div></div>
          <div className="case-stat"><div className="cs-num">$1B</div><div className="cs-lbl">MANTRA Deal Value</div></div>
        </div>
        <div className="case-desc" style="margin-bottom:16px;">
        ...
        <div style="border-top:1px solid var(--border2);padding-top:16px;margin-top:8px;">
          ...
          <div className="player-grid" style="gap:8px;margin-bottom:0;">
            <div className="player-card" style="padding:12px;">
              ...
              <div className="player-cat">Blockchain Infrastructure</div>
              <div className="player-detail">Native token issuance. Low-cost, fast settlement. Built-in DEX for secondary trading. XRPL's native tokenization removes the need for complex third-party smart contracts.</div>
            </div>
            <div className="player-card" style="padding:12px;">
              <div className="player-name" style="font-size:12px;">Ctrl Alt Solutions</div>
              <div className="player-cat">Platform Infrastructure</div>
              <div className="player-detail">Full-stack tokenization platform: investor portal, smart contracts, DLD integration, KYC/AML engine, payment processing, secondary market. The car built to run on XRPL roads.</div>
            </div>
            <div className="player-card" style="padding:12px;">
              <div className="player-name" style="font-size:12px;">Dubai Land Department</div>
              <div className="player-cat">Legal Custodian</div>
              <div className="player-detail">Government authority custodying physical title deeds. DLD's Real Estate Tokenization Pilot officially recognizes blockchain-registered property ownership. Regulatory legitimacy layer.</div>
            </div>
            <div className="player-card" style="padding:12px;">
            ...
            <div className="player-card" style="padding:12px;">
              <div className="player-name" style="font-size:12px;">USDC / Circle</div>
              <div className="player-cat">USD Settlement Layer</div>
              <div className="player-detail">International investors can acquire tokens using USDC, providing USD-denominated entry. Circle's USDC on multiple chains ensures global investor accessibility with stable value settlement.</div>
            </div>
            <div className="player-card" style="padding:12px;">
              <div className="player-name" style="font-size:12px;">MANTRA Chain</div>
              <div className="player-cat">Expansion Partner ($1B)</div>
              <div className="player-detail">DAMAC's $1B deal with MANTRA (RWA-native L1 blockchain, MAS-licensed node operators) signals multi-chain strategy. MANTRA handles additional tokenized product lines beyond PRYPCO Mint.</div>
            </div>
            <div className="player-card" style="padding:12px;">
              <div className="player-name" style="font-size:12px;">VARA (Dubai)</div>
              <div className="player-cat">Regulatory Authority</div>
              <div className="player-detail">Dubai's Virtual Assets Regulatory Authority provides licensing framework for token issuance and trading. VARA's clear framework is a primary reason UAE attracts more tokenization projects than any other MENA jurisdiction.</div>
            </div>
            <div className="player-card" style="padding:12px;">
              <div className="player-name" style="font-size:12px;">Chainlink CCIP</div>
              <div className="player-cat">Cross-Chain Interoperability</div>
              <div className="player-detail">As PRYPCO expands to multiple blockchains, Chainlink CCIP provides the cross-chain bridge so XRPL tokens can move to Ethereum or MANTRA. Endorsed by JPMorgan as the institutional standard.</div>
            </div>
          </div>
        </div>
        <div style="border-top:1px solid var(--border2);padding-top:16px;margin-top:16px;">
          ...
          <div className="info-block" style="margin-bottom:12px;">
    ...
    <div className="case-card">
      ...
      <div className="case-card-body">
        <div className="case-stat-row">
          <div className="case-stat"><div className="cs-num">$5B</div><div className="cs-lbl">Market Cap</div></div>
          <div className="case-stat"><div className="cs-num">#5</div><div className="cs-lbl">Largest Stablecoin</div></div>
          <div className="case-stat"><div className="cs-num">9 months</div><div className="cs-lbl">To reach $5B</div></div>
        </div>
        <div className="case-desc">World Liberty Financial (co-founded by Trump's three sons) launched USD1 in March 2025 — 100% backed by US cash and cash equivalents, custodied by BitGo Trust. By early 2026 it reached $5B market cap (largely via Binance partnership), becoming the world's 5th largest stablecoin in under a year. WLF also partnered with Securitize and DarGlobal to tokenize a Trump-branded Maldives resort. The platform is expanding into tokenized commodities, debt instruments, and institutional DeFi.</div>
      </div>
    </div>
    <div className="case-card">
      <div className="case-card-head">
        <div className="case-logo">Ondo Finance</div>
        <div className="case-sub">Institutional DeFi Yield Layer · Multi-Chain</div>
      </div>
      <div className="case-card-body">
        <div className="case-stat-row">
          <div className="case-stat"><div className="cs-num">$2.5B</div><div className="cs-lbl">TVL</div></div>
          <div className="case-stat"><div className="cs-num">OUSG+USDY</div><div className="cs-lbl">Products</div></div>
          <div className="case-stat"><div className="cs-num">4–5%</div><div className="cs-lbl">Yield</div></div>
        </div>
        <div className="case-desc">Ondo Finance solved a critical problem: crypto-native capital sitting in stablecoins earned zero yield. OUSG (tokenized US Treasuries) lets DeFi protocols and institutions park billions in government-backed, yield-bearing instruments without leaving the blockchain. USDY is a yield-bearing stablecoin alternative. Ondo Global Markets extends this to tokenized stocks. A $2.5B TVL in just a few years validates institutional appetite for on-chain yield.</div>
      </div>
    </div>
    <div className="case-card">
      <div className="case-card-head">
        <div className="case-logo">Figure Technologies</div>
        <div className="case-sub">Tokenized Private Credit at Scale · Provenance BC</div>
      </div>
      <div className="case-card-body">
        <div className="case-stat-row">
          <div className="case-stat"><div className="cs-num">$10B</div><div className="cs-lbl">Loans Tokenized</div></div>
          <div className="case-stat"><div className="cs-num">HELOC</div><div className="cs-lbl">Primary Product</div></div>
          <div className="case-stat"><div className="cs-num">Provenance</div><div className="cs-lbl">Blockchain</div></div>
        </div>
        <div className="case-desc">Figure Technologies has tokenized $10 billion in home equity lines of credit (HELOCs) and mortgage-backed assets on its proprietary Provenance Blockchain. This is private credit tokenization at unprecedented scale. Figure demonstrates that the financial plumbing works: originate a loan, tokenize it, sell it to investors globally in minutes. The company is now expanding into auto loans, student loans, and commercial real estate credit.</div>
      </div>
    </div>
    <div className="case-card">
      <div className="case-card-head">
      ...
      <div className="case-card-body">
        <div className="case-stat-row">
          <div className="case-stat"><div className="cs-num">$2B</div><div className="cs-lbl">Bond Tokenization MOU</div></div>
          <div className="case-stat"><div className="cs-num">Punjab</div><div className="cs-lbl">DAMAC Agreement</div></div>
          <div className="case-stat"><div className="cs-num">PVARA</div><div className="cs-lbl">New Regulator</div></div>
        </div>
        <div className="case-desc">Pakistan executed a sophisticated multi-partner digital asset strategy: signed MOU with World Liberty Financial (USD1) for DeFi infrastructure; signed Binance MOU to tokenize $2B in sovereign bonds and treasury bills; Punjab province signed DAMAC agreement to tokenize government and commercial assets. Pakistan Crypto Council chairs Bilal Bin Saqib serves dual roles as WLF adviser and PVARA chairman. A $7.2T agricultural economy with 37% workforce in farming presents massive crop tokenization potential.</div>
      </div>
    </div>
    <div className="case-card">
      <div className="case-card-head">
        <div className="case-logo">RealT</div>
        <div className="case-sub">Fractional US Real Estate · Ethereum · Since 2019</div>
      </div>
      <div className="case-card-body">
        <div className="case-stat-row">
          <div className="case-stat"><div className="cs-num">1,500+</div><div className="cs-lbl">Properties</div></div>
          <div className="case-stat"><div className="cs-num">65,000+</div><div className="cs-lbl">Investors</div></div>
          <div className="case-stat"><div className="cs-num">$50</div><div className="cs-lbl">Min. Investment</div></div>
        </div>
        <div className="case-desc">RealT pioneered fractional US real estate tokenization on Ethereum. 1,500+ properties tokenized, 65,000+ global investors. Weekly rental yield distributions paid in USDC directly to token holders' wallets — automatically, every Wednesday. A Detroit rental property investor in Nigeria receives yield the same as one in New York. This is the promise of borderless fractional ownership fully realized at consumer scale.</div>
      </div>
    </div>
  </div>
</section>
...
<section id="players">
  ...
  <p className="sec-sub">The tokenization ecosystem spans over 200 active companies across 9 categories. Here are the most consequential across each layer of the stack.</p>
  ...
  <div className="player-grid">
    <div className="player-card">
      <div className="player-name">Securitize</div>
      <div className="player-cat">Primary Platform</div>
      <div className="player-detail">$4B+ tokenized. BlackRock BUIDL, WLF partnership. SEC-registered transfer agent.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Tokeny</div>
      <div className="player-cat">Compliance Infrastructure</div>
      <div className="player-detail">Created ERC-3643 standard. 120+ customers. EU-focused institutional platform.</div>
    </div>
    <div className="player-card">
    ...
    <div className="player-card">
      <div className="player-name">Centrifuge</div>
      <div className="player-cat">RWA Protocol</div>
      <div className="player-detail">$1.3B+ distributed. Private credit, trade finance, and real estate pools.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Taurus (TAURUS)</div>
      <div className="player-cat">Swiss Infrastructure</div>
      <div className="player-detail">Backed by Deutsche Bank. Enterprise-grade custody and tokenization for regulated institutions.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Ctrl Alt Solutions</div>
      <div className="player-cat">UAE Platform</div>
      <div className="player-detail">XRPL-based tokenization. Powers PRYPCO/DAMAC. DLD integration. KYC/AML + secondary market.</div>
    </div>
    <div className="player-card">
      <div className="player-name">DigiFT</div>
      <div className="player-cat">Singapore Exchange</div>
      <div className="player-detail">MAS-licensed digital asset exchange. Tokenized bonds, structured products, and funds.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Polymath/Polymesh</div>
      <div className="player-cat">Security Token Chain</div>
      <div className="player-detail">Purpose-built blockchain for security tokens. Built-in KYC, compliance, and governance.</div>
    </div>
  </div>
  ...
  <div className="player-grid">
    <div className="player-card">
      ...
      <div className="player-cat">Asset Manager</div>
      <div className="player-detail">$10T AUM. BUIDL fund. Invested in Securitize. The institutional seal of approval for tokenization.</div>
    </div>
    <div className="player-card">
      <div className="player-name">JP Morgan</div>
      <div className="player-cat">Investment Bank</div>
      <div className="player-detail">Onyx blockchain, JPM Coin (intrabank settlement). Tokenized repo and collateral management.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Goldman Sachs</div>
      <div className="player-cat">Investment Bank</div>
      <div className="player-detail">Digital Asset Platform (DAP). Tokenized bonds, structured products. "Debasement trade" gold thesis.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Franklin Templeton</div>
      <div className="player-cat">Asset Manager</div>
      <div className="player-detail">First US-registered mutual fund on blockchain. Benji product $880M+. Stellar + Polygon.</div>
    </div>
    <div className="player-card">
      <div className="player-name">UBS</div>
      <div className="player-cat">Swiss Bank</div>
      <div className="player-detail">$500M tokenized bond. Tokenized money market fund. Active in tokenized fixed income.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Zand Bank (UAE)</div>
      <div className="player-cat">Digital Bank</div>
      <div className="player-detail">UAE's first digital bank. Zand AED stablecoin. Developer-focused banking for tokenization ecosystem.</div>
    </div>
  </div>
  ...
  <div className="player-grid">
    <div className="player-card">
      <div className="player-name">Ethereum</div>
      <div className="player-cat">L1 Blockchain</div>
      <div className="player-detail">Dominant platform for institutional RWAs. BlackRock BUIDL, Ondo, MakerDAO all on ETH. EVM standard.</div>
    </div>
    <div className="player-card">
      <div className="player-name">XRP Ledger (Ripple)</div>
      <div className="player-cat">L1 Blockchain</div>
      <div className="player-detail">Native tokenization built-in. PRYPCO/DAMAC. Low fees. Ripple's CBDC solution for central banks.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Solana</div>
      <div className="player-cat">L1 Blockchain</div>
      <div className="player-detail">High-speed, low-cost. Growing institutional RWA presence. Franklin Templeton expanded to SOL 2024.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Avalanche</div>
      <div className="player-cat">L1 Blockchain</div>
      <div className="player-detail">Subnet architecture ideal for permissioned institutional networks. JPMorgan Onyx pilot. KKR fund on Avalanche.</div>
    </div>
    <div className="player-card">
      <div className="player-name">Chainlink</div>
      <div className="player-cat">Oracle + CCIP</div>
      <div className="player-detail">Institutional data standard. CCIP = cross-chain interoperability protocol. JPMorgan-endorsed standard.</div>
    </div>
    <div className="player-card">
      <div className="player-name">MANTRA Chain</div>
      <div className="player-cat">RWA-Native L1</div>
      <div className="player-detail">Purpose-built for RWAs. $1B deal with DAMAC Group (UAE real estate). MAS-licensed node operators.</div>
    </div>
  </div>
</section>
...
<section id="monetary">
  ...
  <p className="sec-sub">The rise of tokenization and digital assets is not happening in a vacuum. It is a direct response to structural instabilities in the fiat monetary system that have been building for decades. Understanding the macro context is essential.</p>
...
<section id="pakistan">
  ...
  <div className="three-col">
    <div className="card">
      <div className="card-icon">🏙️</div>
      <div className="card-h">UAE / Dubai</div>
      <div className="card-p">VARA regulatory framework, ADGM financial center, PRYPCO tokenized real estate, Digital Dirham CBDC, Zand Bank AED stablecoin. Most advanced regulatory ecosystem outside Singapore. $800B+ real estate market ideal for tokenization.</div>
      <span className="card-tag tag-gold">Most Active MENA Hub</span>
    </div>
    <div className="card">
      <div className="card-icon">🌴</div>
      <div className="card-h">Southeast Asia</div>
      <div className="card-p">Singapore (MAS licensing, Project Orchid), Thailand (BOT CBDC, tokenized bonds), Vietnam, Philippines (remittance corridors). ASEAN cross-border remittance via stablecoin is $100B+ opportunity annually.</div>
      <span className="card-tag tag-blue">Remittance + Trade Finance</span>
    </div>
    <div className="card">
      <div className="card-icon">🌍</div>
      <div className="card-h">Africa</div>
      <div className="card-p">60%+ unbanked population, massive commodity reserves (gold, copper, cobalt), growing mobile money infrastructure. Tokenized agricultural commodities, land registry on-chain, and stablecoin remittance corridors represent leapfrog opportunities worth trillions.</div>
      <span className="card-tag tag-green">Leapfrog Potential</span>
    </div>
  </div>
</section>
...
<section id="fintech" style="padding-top:60px;">
  ...
  <div className="risk-bars">
    ...
    <div className="risk-row"><div className="risk-name">Fiat Stablecoins</div><div className="risk-bar-bg"><div className="risk-bar-fill" style="width:20%;background:var(--green);"></div></div><div className="risk-val">Low</div></div>
    <div className="risk-row"><div className="risk-name">Tokenized Real Estate</div><div className="risk-bar-bg"><div className="risk-bar-fill" style="width:45%;background:var(--gold);"></div></div><div className="risk-val">Med</div></div>
    <div className="risk-row"><div className="risk-name">Tokenized Private Credit</div><div className="risk-bar-bg"><div className="risk-bar-fill" style="width:55%;background:var(--gold);"></div></div><div className="risk-val">Med-H</div></div>
    <div className="risk-row"><div className="risk-name">Algo Stablecoins</div><div className="risk-bar-bg"><div className="risk-bar-fill" style="width:85%;background:var(--red);"></div></div><div className="risk-val">High</div></div>
    <div className="risk-row"><div className="risk-name">Cryptocurrency</div><div className="risk-bar-bg"><div className="risk-bar-fill" style="width:90%;background:var(--red);"></div></div><div className="risk-val">Very High</div></div>
  </div>
...
{/* chatbot rendered below */}
      ...
      <div id="chat-widget">
        <button
          ...
          aria-label="Open Digital Czar AI"
        >🤖</button>
        {chatOpen && (
          <div id="chat-panel" className="open">
            ...
            <div id="chat-messages">
              ...
              {isThinking && (
                <div className="msg msg-thinking">Thinking...</div>
              )}
            ...
            <div className="quick-asks">
              {[
                ...
                "What is a CBDC and should I be concerned?",
                "How can I invest in tokenized real estate today?",
                "What is the GENIUS Act and why does it matter?"
              ].map((q, i) => (
                <button key={i} className="qa-btn" onClick={() => sendMessage(q)}>
...
<div id="home">
  ...
  <div className="hero-content">
    ...
    <div className="hero-ctas">
      <button className="btn-primary" onclick="document.getElementById('tokenization').scrollIntoView({behavior:'smooth'})">Start Learning</button>
      <button className="btn-secondary" onclick="document.getElementById('case-studies').scrollIntoView({behavior:'smooth'})">View Case Studies</button>
      <button className="btn-secondary" onclick="document.getElementById('chat-panel').classList.add('open')">⚡ Ask the Digital Czar</button>
    </div>
  </div>
  <div className="stats-bar" style="padding:0 24px;margin:0 auto 0;max-width:1400px;">
    <div className="stat-item">
