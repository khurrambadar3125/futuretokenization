  ...
  <div class="card-grid" style="grid-template-columns:repeat(auto-fill,minmax(320px,1fr));">
    ...
    <div class="case-card">
      ...
      <div class="case-card-body">
        ...
        <div class="case-desc">Pakistan executed a sophisticated multi-partner digital asset strategy: signed MOU with World Liberty Financial (USD1) for DeFi infrastructure; signed Binance MOU to tokenize $2B in sovereign bonds and treasury bills; Punjab province signed DAMAC agreement to tokenize government and commercial assets. Pakistan Crypto Council chairs Bilal Bin Saqib serves dual roles as WLF adviser and PVARA chairman. A $7.2T agricultural economy with 37% workforce in farming presents massive crop tokenization potential.<br/><br/><strong>The Missing Piece Now Exists:</strong> every MOU above answers "what gets tokenized and with whom." None answered "who holds the keys." That answer arrived in October 2025 with the incorporation of the Strategic Digital Wallet Company — the sovereign custodian through which the Bitcoin reserve, tokenized bonds, and any future digital rupee settlement must ultimately flow. Its distinguishing feature is not technology but governance: created under the SOE Act 2023, it is bound to majority-independent board composition and fit-and-proper vetting — an IMF-grade governance wrapper around sovereign crypto custody that no other emerging-market Bitcoin strategy currently has.<br/><br/><strong>Reality check (keep the codex honest):</strong> the Strategic Bitcoin Reserve remains announcement-stage — holdings are seized/forfeited assets in state custody, no funded balance sheet has been disclosed, and the State Bank of Pakistan maintains a publicly cautious line. Pakistan's 2026 story is infrastructure and governance, not yet accumulation. The scaffolding went up before the assets went in — which, for long-term credibility, is the right order.</div>
      </div>
    </div>
    <div class="case-card">
      <div class="case-card-head">
...
<section id="pakistan">
  ...
  <div class="two-col">
    ...
    <div>
      ...
      <div class="info-block">
        <h4>The Five-Layer National Architecture</h4>
        <p style="margin-bottom:10px;"><strong>Layer 0 — The Sovereign Custodian (Strategic Digital Wallet Company):</strong> the vault and rails beneath everything else. A wholly government-owned company incorporated October 2025 under the SOE Act 2023 as the foundational infrastructure for managing Pakistan's digital assets — custody of the national Bitcoin wallet, tokenized government bonds, sovereign digital currencies, and cross-border blockchain settlement in a regulated environment. Founding board: Joint Secretaries of the Finance, Cabinet, and Law &amp; Justice Divisions, with an interim CEO pending regular appointment under the Act. Every layer above ultimately settles through, or is custodied by, this entity.</p>
        <p style="margin-bottom:10px;"><strong>Layer 1:</strong> USD1 / DeFi infrastructure (World Liberty Financial MOU) — digital dollar settlement layer. <strong>Layer 2:</strong> Sovereign bonds and commodity tokenization (Binance MOU) — government debt on-chain. <strong>Layer 3:</strong> Real estate and commercial asset tokenization (DAMAC/Punjab) — private sector assets. <strong>Layer 4:</strong> Agricultural commodity tokenization (crop-backed digital assets) — base economy assets.</p>
        <p><em>Analytical note: Layers 1–4 are announcement-stage MOUs and pilots. Layer 0 is the only layer that exists as an incorporated legal entity — which is why it is the one to watch.</em></p>
      </div>
      <div class="info-block">
        <h4>The Governance Wrapper — Why Pakistan's Model Is Structurally Unusual</h4>
        <p style="margin-bottom:10px;">SDWC was born under the State-Owned Enterprises (Governance and Operations) Act, 2023 — enacted under IMF programme conditions. The Act requires majority-independent boards (outside professionals, not serving officials), rigorous fit-and-proper vetting under Schedule IV with formal declarations of independence, and director appointments routed through a Board Nomination Committee process with a central register held by the Finance Division.</p>
        <p>The structural consequence: Pakistan's state crypto custodian cannot legally remain a bureaucrats-only entity — the law forces technologists, finance, and legal professionals into the majority of its boardroom. Most sovereign Bitcoin experiments (El Salvador, Bhutan) built the asset position first and improvised governance afterward. Pakistan has the governance statute in place before the balance sheet exists. For institutional observers, that sequencing is the single most credible feature of the entire national strategy.</p>
      </div>
    </div>
  </div>
...
<section id="news" style="padding-top:80px;">
  ...
  <div class="news-grid" style="margin-bottom:56px;">
    ...
    <div class="news-card">
      <div class="news-meta"><span class="news-tag tag-gold">INFRASTRUCTURE</span><span class="news-date">Oct 2025</span></div>
      <h4>Strategic Digital Wallet Company Incorporated — The State's Digital Asset Custodian Exists</h4>
      <p>The federal cabinet incorporated the Strategic Digital Wallet Company, a wholly government-owned entity under the SOE Act 2023, to serve as foundational infrastructure for managing Pakistan's digital assets: custody of the national Bitcoin wallet, tokenized government bonds, sovereign digital currency rails, and cross-border blockchain settlement. Founding directors were drawn from the Finance, Cabinet, and Law &amp; Justice Divisions, with an interim CEO named pending board appointment of a regular chief executive. Under the SOE Act, the company's board must ultimately hold a majority of independent directors vetted through fit-and-proper criteria — meaning the state's most trust-critical digital finance entity is legally required to be governed, in majority, by outside professionals.</p>
      <div class="news-footer"><span class="news-source">Sources: ProPakistani, TechJuice, Gazette of Pakistan (SOE Act 2023)</span></div>
    </div>
